    ...
    <section className="bg-gray-300 py-20 px-6 flex justify-center items-center ">
      <div className=" flex-col mx-auto ">
        <div className="mx-auto flex flex-col w-fit text-center">
          ...
          <h1 className="md:text-8xl text-5xl pb-11 font-medium ">
            Why Work with Me
          </h1>
        </div>
        ...
        <div className=" flex flex-col md:flex-row gap-5 md:w-[65%] mx-auto ">
          <div className="border-0 rounded-2xl py-10 px-10 bg-pink-50">
            ...
            <p>
              I believe that every brand is unique and deserves a website that
              is just as distinctive.
            </p>
          </div>
          ...
          <div className=" border-0 rounded-2xl py-9 px-5 bg-pink-50">
            ...
            <p>
              With a strong focus on user experience, I design websites that are
          ...
          <div className="border-0 rounded-2xl py-9 px-5  bg-pink-50">
            ...
            <p>
              I stay at the forefront of web design trends and Technologies to
              offer you the most innovation solutions.
            </p>
          </div>
        </div>
      </div>
